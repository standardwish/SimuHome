...
import type { GenerationRunsPanelProps } from "@/types/generation/components";
...
export function GenerationRunsPanel({
  ...
  return (
    <Surface title="Complete runs" caption="Monitor generation outputs and open a full run detail page.">
      <Stack spacing={2}>
        <MetricStrip
          items={[
            {
